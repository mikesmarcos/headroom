...
- Memory
- Transforms Content Router
- Client
- Proxy
- Config
- Evals Core
- Proxy Handlers Anthropic
- Proxy Handlers
- Memory Ports
- Telemetry Collector
- Transforms Code Compressor
...
- Learn Plugins
- Evals Memory Runner
- Memory Backends Direct
- Transforms Content Detector
- Memory Adapters Sqlite
- Cli Wrap
- Install Runtime
- Integrations Agno Model
- Memory Adapters Fts5
- Cli Learn
- Learn Writer
- Ccr Batch Processor
- Evals Extraction
- Transforms Kompress Compressor
- Audit
- Evals Memory Runner
- Cache Compression Feedback
- Evals Memory Runner
- Transforms Anchor Selector
- Providers Opencode
- Integrations Agno
- Proxy Ws Session
...
- Cli Wrap
- Image Compressor
- Integrations Langchain Streaming
- Ml
- Proxy Handlers Streaming
- Integrations Langchain Chat
- Cli Install
- Perf Analyzer
- Proxy Output Shaper
- Evals Comprehensive Benchmark
- Evals Prompt Comparison
...
- Proxy Handlers Openai
- Providers Registry
- Transforms Log Compressor
- Transforms Kompress Compressor
- Proxy Helpers
- Cache Prefix Tracker
- Cache Semantic
- Proxy Output Savings
- Compression Handlers Code
- Compression Masks
- Evals Adversarial Grid
- Memory Adapters Sqlite
- Providers Copilot Wrap
- Transforms Read Lifecycle
- Backends Base
- Cache Anthropic
- Cli Doctor
- Compression Universal
- Evals Session Probes
- Install Providers
- Providers Codex
- Proxy Cost
...
- Memory Backends Mem0
- Memory Adapters Hnsw
- Memory Backends Local
- Memory Ports
- Prediction Feature Extractor
- Cache Backends Sqlite
- Compression Handlers Base
- Pricing Registry
- Providers Proxy Routes
- Image Trained Router
- Rtk Installer
- Memory Adapters Sqlite
- Evals Oss Benchmarks
- Proxy Forwarded Headers
- Mcp Registry Claude
- Providers Anthropic
- Tokenizers Tiktoken Counter
- Integrations Langchain Retriever
- Install
- Integrations Langchain Langsmith
- Mcp Registry
- Memory Adapters Cache
- Providers Openai Compatible
- Backends Anyllm
- Backends Litellm
- Integrations Langchain Agents
- Binaries
- Cache Backends Base
- Storage Jsonl
- Proxy Stage Timer
...
- Cli Update
- Integrations Langchain Chat
- Memory Wrapper Tools
- Savings Ledger
- Storage Base
- Utils
- Subscription
- Compression Handlers Handler
- Transforms Read Maturation
- Integrations Strands
- Learn Plugins Claude
- Memory Tracker
- Tokenizers Mistral
- Integrations Strands Hooks
- Cache Openai
- Cli Wrap
- Cli Wrap
- Evals Batch Compression
- Evals Cost Tracker
- Evals Runners Compression
- Mcp Registry Opencode
...
- Subscription Tracker
- Telemetry Backends
- Transforms Lossless Compaction
- Copilot Auth
- Evals Batch Compression
- Image Tile Optimizer
- Integrations Strands Bundle
- Memory Adapters Hnsw
- Proxy Ssl Context
- Subscription Codex Rate
- Transforms Search Compressor
- Cache Registry
- Ccr Batch Store
- Memory Tracker
- Evals Metrics
- Integrations Litellm Callback
- Lean Ctx Installer
- Proxy Output Savings
- Providers Litellm
- Relevance Embedding
...
- Proxy Probe Recorder
- Transforms Adaptive Sizer
- Cli Mcp
- Graph Tokensave Installer
- Headroom Dashboard Templates
- Providers Openai
- Memory Inline Extractor
- Memory Mcp Server
...
- live_zone_token_validation.rs
- handle_chat_completions
- sse_openai_responses.rs
- index.mdx
- langchain.mdx
- strands.mdx
- text-and-logs.mdx
...
- CCR Retrieval
- Compression
- Compression-Only Evaluation
- Headroom Proxy Evaluation Stack
- No Accuracy Loss
- Session Probes
- SuiteRunner
...
- `boot_proxy()` --calls--> `create_app()`  [EXTRACTED]
  scripts/replay_codex_ws_load.py → headroom/proxy/server.py
...
- **Proxy Evaluation Stack Components** — headroom_evals_readme_compression, headroom_evals_readme_ccr_retrieval, headroom_evals_readme_cache_alignment, headroom_evals_readme_headroom_proxy_eval_stack [EXTRACTED 1.00]
...
### Community 2 - "Client"
Cohesion: 0.04
Nodes (38): Initialize the LRU cache.          Args:             max_size: Maximum number of, BetaHeaderStickyMode, Policy helpers for beta-header stickiness configuration., Resolve beta-header stickiness mode from an environment value., Resolve the positive LRU session bound for beta-header tracking., resolve_beta_header_sticky_mode(), resolve_beta_tracker_max_sessions(), BodyMutationTracker (+30 more)
...
### Community 21 - "Transforms Content Router"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (46): CallModel, extract_system_prompt(), Any, Best-effort extraction of the system prompt across providers.      Anthropic put, Return the client IP to use for logging / auth / rate-limit.      Always falls b, resolve_client_ip(), _anthropic_outcome_provider(), _header_get() (+38 more)
...
Cohesion: 0.13
Nodes (39): assistant_message_not_in_live_zone(), auth_mode_does_not_affect_b3_outcome_for_short_input(), AuthMode, body(), compress_anthropic_live_zone(), compress_openai_chat_live_zone(), compress_openai_responses_live_zone(), compresses_multiple_same_frame_outputs() (+31 more)

### Community 58 - "Cli Wrap"
Cohesion: 0.08
Nodes (25): Cost tracking and budget management for the Headroom proxy.  Contains the CostTr, Collapse repeated transforms into counted summary.      e.g. ['router:excluded:t, _summarize_transforms(), Complete log of a single request., RequestLog, is_token_mode(), Proxy run mode helpers.  Canonical modes: - token: prioritize compression (histo, Return True when mode resolves to token mode. (+17 more)
...
Cohesion: 0.07
Nodes (66): canonical_array_json(), canonical_json_for_match(), ccr_hash_changes_with_input(), ccr_hash_is_deterministic(), compaction_kind_str(), compaction_skips_non_object_array(), crush_array_keeps_error_items(), crush_array_low_uniqueness_compresses() (+58 more)

### Community 61 - "Ml"
Cohesion: 0.04
Nodes (70): _build_digest(), _build_prior_patterns_section(), FailureAnalyzer, _format_event(), _format_tool_call(), Session analysis via LLM — replaces all regex/heuristic analysis.  Pipeline: Sca, Analyzes session data via LLM to produce actionable recommendations.      Uses L, Analyze sessions and produce recommendations via LLM. (+62 more)
...
### Community 78 - "Proxy Prometheus Metrics"
Cohesion: 0.06
...
### Community 79 - "Ccr Response Handler"
Cohesion: 0.12
...
### Community 95 - "Providers Copilot Wrap"
Cohesion: 0.07
...
### Community 111 - "Integrations Strands Model"
Cohesion: 0.25
...
Cohesion: 0.02
Nodes (122): CompressionCache, _CacheEntry, CompressionCache, Content-addressed compression cache with LRU eviction.  Used in "token headroom, Store a compressed version keyed by content hash.          If the hash already e, Mark a content hash as stable (unchanged, not compressed).          Used for too, Whether to defer compressing this content to avoid mid-TTL busts.          Retur, Return cache statistics. (+114 more)
...
### Community 116 - "Prediction Feature Extractor"
Cohesion: 0.25
...
### Community 119 - "Pricing Registry"
Cohesion: 0.11
...
### Community 134 - "Providers Openai Compatible"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (7): Acceptance criteria, Blocked by, Blocks, Files, PR-E5 — Volatile-content detector with customer warning (no rewrite), Rollback, Scope
...
### Community 149 - "Storage Base"
Cohesion: 0.06
Nodes (27): detect_id_field_statistically(), detect_score_field_statistically(), id_field_high_entropy_strings(), id_field_high_uniqueness_alone_triggers_catchall(), id_field_low_uniqueness_rejected(), id_field_sequential_numeric(), id_field_uuid_strings_high_confidence(), Value (+19 more)

### Community 150 - "Utils"
Cohesion: 0.07
Nodes (38): main(), Result, Cli, Cmd, first_line(), main(), Option, PathBuf (+30 more)

### Community 151 - "Subscription"
Cohesion: 0.33
Nodes (6): Acceptance criteria, Blocked by, Blocks, Files, PR-I3 — Property tests for compression invariants, Scope

### Community 152 - "Compression Handlers Handler"
Cohesion: 0.14
...
### Community 176 - "Mcp Registry Codex"
Cohesion: 0.33
...
Cohesion: 0.07
Nodes (49): ConversationScanner, ABC, Base class for headroom learn plugins.  Each coding agent (Claude Code, Codex, G, Base class for scanning conversation logs from any agent system.      Subclasses, Discover all projects with conversation data., Scan all sessions for a project, returning normalized tool calls., ProjectInfo, str (+41 more)
...
### Community 188 - "Telemetry Backends"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (13): ContextEntry, SharedContext — compressed inter-agent context sharing.  When agents hand off to, Get content by key.          Args:             key: The key to retrieve., Get the full ContextEntry with metadata., List all non-expired keys., Get aggregated stats., Evict expired and oldest entries if at capacity. Lock must be held., A stored context entry with original and compressed versions. (+5 more)

### Community 207 - "Subscription Codex Rate"
Cohesion: 0.40
...
### Community 208 - "Subscription Session Tracking"
Cohesion: 0.50
Nodes (4): Advanced Configuration, Custom LaunchAgent Schedule, Multiple Proxy Instances, Resource Limits

### Community 209 - "Cli Toin Publish"
Cohesion: 0.50
Nodes (4): API Key Security, LaunchAgent vs LaunchDaemon, Network Security, Security Considerations

### Community 210 - "Integrations Asgi"
Cohesion: 0.13
Nodes (12): ASGIApp, CompressionMiddleware, Any, Scope, Send, ASGI Middleware — add Headroom compression to any Python proxy.  Drop-in middlew, Compress locally using headroom.compress()., Compress via Headroom Cloud API (managed CCR, TOIN, analytics). (+4 more)

### Community 211 - "Cli Evals"
Cohesion: 0.50
...
### Community 225 - "Transforms Adaptive Sizer"
Cohesion: 0.06
...
### Community 228 - "Headroom Dashboard Templates"
Cohesion: 0.13
Nodes (17): downloadHistory, escapeHtml, fetchHistoryStats, fetchStats, fetchTransformations, Health Endpoint, Historical Proxy Compression, init (+9 more)
...
### Community 231 - "Memory Mcp Server"
Cohesion: 0.08
...
### Community 232 - "Memory Sync Adapters"
Cohesion: 0.67
...
Cohesion: 0.07
Nodes (22): get_sentence_transformer(), get_siglip(), get_spacy(), Any, Centralized registry for ML model instances.  Provides shared access to ML model, Unload one cached model entry., Unload several cached model entries with one runtime cleanup pass., Unload every cached model entry matching a prefix. (+14 more)
...
### Community 260 - "Evals Memory Judge"
Cohesion: 0.13
...
Cohesion: 0.19
Nodes (25): install_static_token_source(), start_proxy_with_state(), adc_bearer_token_signed_correctly(), adc_failure_returns_5xx_no_silent_forward(), assert_byte_equal_sha256(), CapturedUpstream, minimal_vertex_body(), mount_capture_json() (+17 more)
...
### Community 266 - "Proxy Runtime Env"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (40): Seed the process env with the savings-profile defaults (default: coding).      C, seed_proxy_env_defaults(), get_dashboard_html(), Headroom Dashboard - Real-time proxy monitoring UI., Load the dashboard HTML template., apply_offline_env(), is_offline(), Air-gap / no-egress master switch (``HEADROOM_OFFLINE``).  A single predicate th (+32 more)
...
Cohesion: 0.05
Nodes (49): dashboard(), _get_env_bool(), _get_env_bool_optional(), _get_env_int(), _get_env_int_optional(), proxy(), Context, Proxy server CLI commands. (+41 more)
...
### Community 305 - "Memory Writers Cursor"
Cohesion: 0.11
...
### Community 306 - "Proxy Request Logger"
Cohesion: 0.13
...
### Community 307 - "Subscription Tracker"
Cohesion: 0.14
...
### Community 315 - "Memory Writers Generic"
Cohesion: 0.15
...
Cohesion: 0.39
Nodes (7): ensure_ort_dylib_pinned(), _needs_ort_dylib_pin(), Path, Pin the ONNX Runtime dylib for the Rust core on dynamic-ORT platforms.  Why this, Export ``ORT_DYLIB_PATH`` for the Rust core's ort runtime.      Returns the effe, _resolve_and_pin(), _resolve_ort_native_library()
...
Cohesion: 0.10
Nodes (35): ApiKind, apikind_anthropic_scans_correct_paths(), caps_findings_at_ten(), detect_volatile_content(), detects_iso8601_timestamp_in_system_prompt(), detects_request_id_field_in_nested_object(), detects_uuid_v4_in_user_message(), does_not_mutate_input() (+27 more)

### Community 331 - "Subscription Subscriptionstate"
Cohesion: 0.19
Nodes (16): ContentPartState, ItemState, parse_json(), payload_preview(), ResponseState, Bytes, Error, HashMap (+8 more)

### Community 332 - "Transforms Spreadsheet Ingest"
Cohesion: 0.06
...
Cohesion: 0.40
Nodes (5): _parse_llm_response(), Recommendation, Convert LLM structured output into Recommendation objects., Safely convert a value to int., _safe_int()
...
Cohesion: 0.06
Nodes (31): class-variance-authority, clsx, dependencies, class-variance-authority, clsx, fumadocs-core, fumadocs-mdx, fumadocs-twoslash (+23 more)

### Community 354 - "Memory Traffic Learner"
Cohesion: 0.16
...
### Community 355 - "Proxy Handlers Bedrock"
Cohesion: 0.06
...
### Community 356 - "Proxy Savings Tracker"
Cohesion: 0.06
Nodes (30): Acceptance criteria, Acceptance criteria, Acceptance criteria, Acceptance criteria, Blocked by, Blocked by, Blocked by, Blocked by (+22 more)
...
### Community 363 - "Providers Base"
Cohesion: 0.06
Nodes (31): All Options, Anthropic, Cache Aligner Configuration, Command Line Options, Config File Format, Configuration, Configuration Methods, Configuration Precedence (+23 more)

### Community 364 - "Proxy Helpers"
Cohesion: 0.06
...
### Community 400 - "Troubleshooting Guide"
Cohesion: 0.07
...
### Community 434 - "orchestration.rs"
Cohesion: 0.21
...
### Community 438 - "troubleshooting.mdx"
Cohesion: 0.08
...
### Community 443 - "PR-H1 — Retire Python proxy request path"
Cohesion: 0.08
...
### Community 450 - "Quickstart Guide"
Cohesion: 0.08
...
### Community 474 - "ccr_roundtrip.rs"
Cohesion: 0.16
...
### Community 475 - "live_zone_openai.rs"
Cohesion: 0.18
...
### Community 477 - "mount_anthropic_capture"
Cohesion: 0.14
...
### Community 488 - "external_model_skip_reason"
Cohesion: 0.10
...
Cohesion: 0.19
Nodes (17): ArrayAnalysis, compression_plan_default_keep_count_matches_python(), CompressionPlan, CompressionStrategy, crush_result_passthrough(), crushability_skip_helper(), CrushabilityAnalysis, CrushResult (+9 more)

### Community 498 - "installation.mdx"
Cohesion: 0.09
...
### Community 514 - "LegacyMutexStore"
Cohesion: 0.17
...
### Community 519 - "integration_bedrock_invoke.rs"
Cohesion: 0.21
...
### Community 520 - "Proxy-wide (Phase G PR-G3)"
Cohesion: 0.09
...
### Community 539 - "responses_items.rs"
Cohesion: 0.21
...
Cohesion: 0.02
Nodes (174): merge_anthropic_beta(), merge_beta_tokens(), merge_openai_beta(), Deterministic merge helpers for provider beta request headers., Merge client beta tokens with Headroom-required tokens deterministically., Merge client anthropic-beta value with Headroom-required tokens., Merge client OpenAI-Beta value with Headroom-required tokens., Split a comma-separated beta-header value into trimmed tokens. (+166 more)
...
### Community 556 - "fix: Codex proxy resilience under reconnect storms"
Cohesion: 0.10
...
### Community 562 - "integration_e4_openai_cache_key.rs"
Cohesion: 0.26
...
### Community 582 - "log_compressor.rs"
Cohesion: 0.20
...
### Community 585 - "handle_responses"
Cohesion: 0.15
...
### Community 596 - "test_graph.py"
Cohesion: 0.22
Nodes (11): _detect_platform(), download_cbm(), ensure_cbm(), get_cbm_path(), Path, Download and install codebase-memory-mcp binary from GitHub releases., Ensure codebase-memory-mcp is available. Download if needed.      Returns path t, Detect platform and return the release asset suffix. (+3 more)

### Community 599 - "Integration Guide"
Cohesion: 0.11
...
### Community 606 - "integration_bedrock_streaming.rs"
Cohesion: 0.26
...
### Community 607 - "integration_chat_completions.rs"
Cohesion: 0.19
...
### Community 661 - "persistent-installs.mdx"
Cohesion: 0.12
...
### Community 671 - "test_sync_plugin_versions.py"
Cohesion: 0.18
...
### Community 680 - "test_subscription_tracker.py"
Cohesion: 0.07
...
### Community 683 - "Persistent Installs"
Cohesion: 0.12
...
### Community 701 - "P5 — Auth-mode + observability + fingerprinting"
Cohesion: 0.13
...
### Community 717 - "live_zone_dispatch.rs"
Cohesion: 0.31
...
### Community 718 - "auth_mode_layer.rs"
Cohesion: 0.24
...
### Community 719 - "failure-learning.mdx"
Cohesion: 0.14
...
### Community 720 - "filesystem-contract.mdx"
Cohesion: 0.14
...
### Community 742 - "CCR: Compress-Cache-Retrieve"
Cohesion: 0.14
...
### Community 743 - "Filesystem Contract"
Cohesion: 0.14
...
### Community 747 - "mount_anthropic_capture"
Cohesion: 0.24
...
### Community 772 - "sse_anthropic.rs"
Cohesion: 0.29
...
### Community 775 - "image-compression.mdx"
Cohesion: 0.17
...
### Community 777 - "RTK architecture — why wrap-CLI only"
Cohesion: 0.17
...
### Community 780 - "copilot_linux_secret.py"
Cohesion: 0.43
...
### Community 786 - "test_pr_governance.py"
Cohesion: 0.39
...
### Community 803 - "Persistent Deployments / Installs Design"
Cohesion: 0.17
...
### Community 804 - "Strands Integration"
Cohesion: 0.17
...
### Community 810 - "Claude Code + AWS Bedrock, with Headroom compression"
Cohesion: 0.18
...
### Community 813 - "code-compression.mdx"
Cohesion: 0.18
...
### Community 837 - "text-and-logs.mdx"
Cohesion: 0.20
...
### Community 842 - "HeadroomContribution"
Cohesion: 0.44
...
### Community 873 - "claude-code-vertex.mdx"
Cohesion: 0.22
...
### Community 874 - "how-compression-works.mdx"
Cohesion: 0.22
...
### Community 892 - "CCR Architecture: Compress-Cache-Retrieve"
Cohesion: 0.22
...
### Community 893 - "Getting Started with Headroom"
Cohesion: 0.22
...
### Community 894 - "auth_mode.rs"
Cohesion: 0.32
Nodes (3): AuthMode, classify(), HeaderMap

### Community 896 - "LevelClassifier"
Cohesion: 0.29
Nodes (6): count_level(), is_word_boundary(), is_word_byte(), LevelClassifier, LogLevel, AhoCorasick

### Community 897 - "live_zone_ccr.rs"
Cohesion: 0.21
Nodes (11): compress_anthropic_live_zone_with_ccr(), no_change_reason_empty_input_is_no_eligible_items(), Self, tokens_saved_zero_for_empty_manifest(), body_with_payload(), ccr_marker_injected_when_store_wired(), large_json_array_payload(), no_marker_when_store_omitted() (+3 more)
...
### Community 901 - "anthropic-sdk.mdx"
Cohesion: 0.25
...
### Community 906 - "vercel-ai-sdk.mdx"
Cohesion: 0.25
...
Cohesion: 0.40
Nodes (3): Path, Save results to JSON file., Save suite to JSONL file.

### Community 913 - "PR-A3 — Switch Python forwarders to byte-faithful body forwarding"
Cohesion: 0.25
...
### Community 950 - "SmartCrusherConfig"
Cohesion: 0.33
...
Cohesion: 0.03
Nodes (105): is_tool_excluded(), Return True if ``name`` matches the tool-exclusion set.      Plain entries match, Return an Anthropic model id without terminal styling artifacts., Strip model-id styling artifacts from Anthropic model metadata payloads., sanitize_anthropic_model_id(), sanitize_anthropic_model_metadata(), codex_responses_http_url(), has_chatgpt_account_header() (+97 more)

### Community 968 - "Reproducing the reconnect storm"
Cohesion: 0.29
Nodes (6): Fixtures, Install scripts, Interpretation, Reproducing the reconnect storm, Run, scripts/

### Community 973 - "Image Compression Architecture"
Cohesion: 0.29
...
### Community 1020 - "The Data Flow (Step by Step)"
Cohesion: 0.33
...
### Community 1021 - "auth_mode.rs"
Cohesion: 0.60
Nodes (4): bench_classify(), build_headers(), Criterion, HeaderMap

### Community 1022 - "TextCrusherConfig"
Cohesion: 0.40
Nodes (3): Default, Self, TextCrusherConfig

### Community 1024 - "community-savings.mdx"
Cohesion: 0.40
...
### Community 1028 - ".from_dict"
Cohesion: 0.40
Nodes (3): Any, Create from dictionary., Convert to dictionary for serialization.

### Community 1029 - "__init__.py"
Cohesion: 0.40
...
### Community 1035 - "test_pr_health_labels.py"
Cohesion: 0.60
...
### Community 1036 - "verify-versions.py"
Cohesion: 0.70
Nodes (4): main(), Path, _read_json_version(), _read_marketplace_versions()

### Community 1049 - "The Core Components (In Simple Terms)"
Cohesion: 0.40
...
- **Are the 80 inferred relationships involving `start_proxy_with()` (e.g. with `body_size_overflow_returns_413_not_400()` and `body_size_overflow_with_content_length_header_returns_413_without_consuming()`) actually correct?**
  _`start_proxy_with()` has 80 INFERRED edges - model-reasoned connections that need verification._
